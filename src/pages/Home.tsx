  ...
  return (
    <div className="max-w-2xl mx-auto text-center animate-fade-in">
      ...
      <div className="py-12 md:py-16">
        <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-sage-light mb-8">
          <Compass className="h-10 w-10 text-sage" aria-hidden="true" />
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 text-left">
          <article className="calm-card">
            <div className="w-10 h-10 rounded-full bg-sage-light flex items-center justify-center mb-4">
              <span className="text-sage font-bold" aria-hidden="true">1</span>
            </div>
          ...
          <article className="calm-card">
            <div className="w-10 h-10 rounded-full bg-slate-blue-light flex items-center justify-center mb-4">
              <span className="text-slate-blue font-bold" aria-hidden="true">2</span>
            </div>
            <h3 className="font-heading font-bold mb-2">Decision Checker</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
              When facing a choice, reflect on how it aligns with your core values through gentle, guided prompts.
            </p>
          </article>
          
          <article className="calm-card">
            <div className="w-10 h-10 rounded-full bg-sand flex items-center justify-center mb-4">
              <span className="text-charcoal font-bold" aria-hidden="true">3</span>
            </div>
