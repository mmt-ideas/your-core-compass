...
const Home = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto animate-fade-in">
      ...
      {/* Three Tools - Compact */}
      <section className="py-12 border-t border-border" aria-labelledby="tools-heading">
        ...
        <p className="mt-10 pt-6 border-t border-border text-sm text-muted-foreground">
          <span className="font-medium text-foreground">Private by design</span> — all data stays on your device.
        </p>
      </section>
    </div>
  );
